    ...
    mounted() {
        ...
        const monsters = {
            Emby: {
                ...
                image: {
                    src: "~@/assets/baligame/embySprite.png",
                },
                frames: {
                    max: 4,
                    hold: 30,
            ...
            Draggle: {
                ...
                image: {
                    src: "~@/assets/baligame/draggleSprite.png",
                },
                frames: {
                    max: 4,
                    hold: 30,
            ...
            attack({ attack, recipient, renderedSprites }) {
                ...
                switch (attack.name) {
                    case "Fireball": {
                        ...
                        fireballImage.src = "~@/assets/baligame/fireball.png";
        ...
        villagerImg.src = "~@/assets/baligame/villager/Idle.png";

        const oldManImg = new Image();
        oldManImg.src = "~@/assets/baligame/oldMan/Idle.png";
        ...
        image.src = "~@/assets/baligame/Pellet Town.png";

        const foregroundImage = new Image();
        foregroundImage.src = "~@/assets/baligame/foregroundObjects.png";

        const playerDownImage = new Image();
        playerDownImage.src = "~@/assets/baligame/playerDown.png";

        const playerUpImage = new Image();
        playerUpImage.src = "~@/assets/baligame/playerUp.png";

        const playerLeftImage = new Image();
        playerLeftImage.src = "~@/assets/baligame/playerLeft.png";

        const playerRightImage = new Image();
        playerRightImage.src = "~@/assets/baligame/playerRight.png";
        ...
        battleBackgroundImage.src = "~@/assets/baligame/battleBackground.png";
