<template>
    <div class="travel-review mb-4">
        <h2 class = "headername">Package Reviews</h2>
        <div class="container">
    <div class="row">
      <div class="col-12">
        <div id="feedbackList" class="d-flex flex-wrap justify-content-start">
          <div v-for="review in displayedReviews" :key="review.key" class="col-4">
            <div class="review-box card mb-3 mx-3">
        ...
        <div v-if="totalPages > 1" class="d-flex justify-content-center vertical-center">
          <ul class="pagination">
